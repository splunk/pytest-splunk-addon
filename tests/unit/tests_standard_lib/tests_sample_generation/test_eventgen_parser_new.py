...
def test_get_sample_stanzas_with_samples():
    ...
    result = psa_data_parser.get_sample_stanzas()
...
def test_get_sample_stanzas_without_samples(caplog):
    ...
    psa_data_parser.get_sample_stanzas()
