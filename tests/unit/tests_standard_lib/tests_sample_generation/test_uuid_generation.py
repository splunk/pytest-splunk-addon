...
class TestUUIDGeneration:
    ...
    def test_uuid_generated_when_flag_enabled(self):
        """Verify UUID is generated when splunk_ep is True"""
        metadata = {"splunk_ep": True, "index": "main"}
        event = SampleEvent(
    ...
    def test_uuid_not_generated_when_flag_disabled(self):
        """Verify UUID is NOT generated when splunk_ep is False"""
        metadata = {"splunk_ep": False, "index": "main"}
        event = SampleEvent(
            event_string="test event", metadata=metadata, sample_name="test.sample"
        )
    ...
    def test_uuid_not_generated_when_flag_missing(self):
        """Verify UUID is NOT generated when splunk_ep is not specified"""
        metadata = {"index": "main"}
        event = SampleEvent(
            event_string="test event", metadata=metadata, sample_name="test.sample"
        )
...
# TestUUIDCaseSensitivity class removed - no longer relevant with boolean flags
