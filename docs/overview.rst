...
Overview
=============
Pytest splunk addon is an open-source dynamic test plugin for Splunk Apps and Add-ons which allows the user to test Splunk add-ons for knowledge objects and CIM compatibility. 
