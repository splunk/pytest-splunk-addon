# -*- coding: utf-8 -*-
#
# pytest-splunk-addon documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-splunk-addon Documentation',
     [author], 1)
]
