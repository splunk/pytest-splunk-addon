...
3. Add-on parser & Data model handlers 

General modules used accross the package \n
1. app_tests
2. app_test_generator
3. fields
4. addon_parser

To test the Field extractions, the following modules are utilized \n
1. fields_tests
2. fields_test_generator
3. addon_parser
4. field_bank

To test the CIM compatibility, the following modules are utilized \n
1. cim_tests
