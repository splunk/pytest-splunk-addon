...
find ./tests/src -iname "*.tgz" | sed 's/.\/tests\/src\//        - http:\/\/nginx\//g' >> ./k8s_manifests/splunk_standalone/addon_information_updated.yaml
cat ./k8s_manifests/splunk_standalone/splunk_standalone.yaml >> ./k8s_manifests/splunk_standalone/splunk_standalone_updated.yaml
